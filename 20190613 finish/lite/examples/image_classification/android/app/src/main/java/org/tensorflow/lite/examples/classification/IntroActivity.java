...
Button login, register;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Skip = (TextView)findViewById(R.id.skipButton);
        ...
        Skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent skipIntent = new Intent(IntroActivity.this, MainActivity.class);
                IntroActivity.this.startActivity(skipIntent);
            }
        });
